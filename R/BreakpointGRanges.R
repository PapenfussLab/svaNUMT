...
#'@export
findBreakpointOverlaps <- function(query, subject, maxgap=-1L, minoverlap=0L,
								   ignore.strand=FALSE, sizemargin=0.25,
								   restrictMarginToSizeMultiple=0.5) {
	hitdf <- as.data.frame(findOverlaps(query, subject, maxgap=maxgap,
										minoverlap=minoverlap, type="any",
